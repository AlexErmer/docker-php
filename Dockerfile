...
RUN printf 'mysql-server mysql-server/root_password password test' | debconf-set-selections
RUN printf 'mysql-server mysql-server/root_password_again password test' | debconf-set-selections
